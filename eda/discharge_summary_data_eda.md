...
All files follow the InterSystems Cache ObjectScript class structure:

```objectscript
Class Custom.MEXX.Report.ZEN.DischargeSummary[N] Extends ZenReport
{
    // Class parameters
    Parameter REPORTNAME = "Discharge Summary";

    // XData block for report definition
    XData Report [ XMLNamespace = "http://www.intersystems.com/zen/report/definition" ]
    {
        // XML-based report layout
    }

    // Data queries
    Query GetPatientData(PID) As %SQLQuery
    {
        // SQL SELECT statements
    }

    // Report methods
    Method GenerateReport() [ ZenMethod ]
    {
...
### ZEN Framework Components Used

| Component | Purpose |
|-----------|---------|
| `<report>` | Root report container |
| `<group>` | Data grouping element |
| `<table>` | Tabular data display |
| `<field>` | Individual data field |
| `<aggregate>` | Data aggregation functions |
| `<image>` | Image/logo display |
| `<line>` | Horizontal lines/separators |
...
```
318 KB ████████████████████████████████████████  (DischargeSummary11 - Most Complex)
285 KB ████████████████████████████████████████  (DischargeSummary7)
277 KB ██████████████████████████████████████▌  (DischargeSummary1)
274 KB ██████████████████████████████████████▌  (DischargeSummary2)
271 KB ██████████████████████████████████████▋  (DischargeSummary4)
269 KB ██████████████████████████████████████▋  (DischargeSummary6)
252 KB █████████████████████████████████████▊  (DischargeSummary10)
243 KB ████████████████████████████████████▏  (DischargeSummary5)
219 KB ███████████████████████████████▏       (DischargeSummary3)
198 KB ████████████████████████████▏          (DischargeSummary8)
195 KB ███████████████████████████▎           (DischargeSummary9)
  58 KB ██████▌                              (DischargeSummary13)
  52 KB ██████                               (DischargeSummary12)
  40 KB ████▎                                (DischargeSummary15)
  38 KB ████▌                                (DischargeSummary14)
  16 KB ██                                   (DischargeSummary16 - Simplest)
```
...
All source files are located in: `/data/`
...
├── Custom.MEXX.Report.ZEN.DischargeSummary6.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary7.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary8.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary9.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary10.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary11.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary12.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary13.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary14.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary15.cls.pdf
├── Custom.MEXX.Report.ZEN.DischargeSummary16.cls.pdf
└── image001.jpg
```

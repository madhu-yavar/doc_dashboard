...
class ClinicalDataExtractorSkill {
  ...
  async execute(context) {
    ...
    if (!result.success) {
      return { success: false, step: "clinical_data_extractor", error: result.error, usage: result.usage };
    }
    ...
    try {
      ...
      return { success: false, step: "clinical_data_extractor", error: e.message, usage: result.usage };
    }
  }
}

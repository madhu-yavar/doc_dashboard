...
class VitalsExtractorSkill {
  ...
  async execute(context) {
    ...
    if (!result.success) {
      return { success: false, step: "vitals_extractor", error: result.error, usage: result.usage };
    }
    ...
    try {
      ...
      return { success: false, step: "vitals_extractor", error: e.message, usage: result.usage };
    }
  }
}

...
const reviewBadgeClass = "border-transparent bg-amber-50 text-amber-700";
                ...
                <TableBody>
                  {isLoadingDocuments ? (
                    ...
                    filteredDocuments.map((document) => {
                      ...
                      const reviewRequired = !!document.result?.meta?.extraction_escalation?.required;
                            ...
                            <div className="flex items-center gap-3">
                              ...
                              <div>
                                ...
                                {document.status === "failed" && document.error ? (
                                  <p className="mt-1 max-w-[640px] text-xs text-rose-600">
                                    {document.error}
                                  </p>
                                ) : null}
                              </div>
                          ...
                          <TableCell>
                            {document.status === "processing" && processingProgress[document.id] ? (
                              ...
                              <div className="flex flex-wrap items-center gap-2">
                                ...
                                {reviewRequired ? <Badge className={reviewBadgeClass}>Review required</Badge> : null}
                              </div>
                            )}
                          </TableCell>

...
const providerTone: Record<string, string> = {
  ...
  gemini_web_fallback: "bg-indigo-50 text-indigo-700",
  gemini: "bg-cyan-50 text-cyan-700",
  gemma: "bg-violet-50 text-violet-700",
  gemma_external_fallback: "bg-amber-50 text-amber-700",
  internal_fallback: "bg-orange-50 text-orange-700",
...
const providerLabel: Record<string, string> = {
  ...
  gemini_web_fallback: "Gemini Web Fallback",
  gemini: "Gemini",
  gemma: "Gemma",
  gemma_external_fallback: "Gemma Fallback",
  internal_fallback: "Record Fallback",

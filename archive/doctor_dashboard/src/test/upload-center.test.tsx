...
describe("UploadCenter", () => {
  ...
  it("supports selecting rows for batch delete", async () => {
    const { container } = render(
      <MemoryRouter>
        <UploadCenter />
      </MemoryRouter>,
    ...
    fireEvent.click(screen.getByRole("checkbox", { name: /select custom\.mexx\.report\.zen\.dischargesummary3\.cls\.pdf/i }));

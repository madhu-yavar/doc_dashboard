  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        "section-vitals": "hsl(var(--section-vitals))",
        "section-diagnosis": "hsl(var(--section-diagnosis))",
        "section-medications": "hsl(var(--section-medications))",
        "section-labs": "hsl(var(--section-labs))",
        "section-radiology": "hsl(var(--section-radiology))",
        "section-treatment": "hsl(var(--section-treatment))",
